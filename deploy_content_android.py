...
paths = [
    ...
    (
        ...
        "deps/src/3D-Graphics-Rendering-Cookbook/data",
    ),
    (
        "third-party/deps/src/ktx-software/tests/srcimages/Iron_Bars",
        "deps/src/ktx-software/tests/srcimages/Iron_Bars",
    ),
]
